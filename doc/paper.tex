...
We consider this to be a step towards a period-finding construction that uses only $n + O(1)$ qubits total, which could reduce the expected lifetime of current cryptographic keys by months or years (depending on how quickly quantum computers gain error-corrected capacity).
