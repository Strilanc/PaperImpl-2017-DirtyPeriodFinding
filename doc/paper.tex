...
Despite the large reduction in the number of ancilla available to the underlying arithmetic operations, each operation would still have more than enough ancilla and contribute no additional ancilla to the overall circuit.
